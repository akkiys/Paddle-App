...
<input type="hidden"  name="userId" value='<c:out value="${sessionScope.userId}"/>' />
	...
	<div class="wrap-app">
       ...
       <form action="/ClientUpdateJob.html" method="post" class="custom" >    <!--Action   -->
 ...
 <input type="hidden" name="jobId" value="<c:out value='${jobDetails.id}'/>">
		   <div class="row">
	             ...
	             <div class="large-4 columns">  
			        ...
			        <input type="hidden" name="editSupplierList" value="<c:out value='${jobDetails.supplierId}'/>">
			        <input type="text" placeholder="Enter Supplier Name" name="EditClientName" id="EditClientName" required = "required" value="<c:out value='${jobDetails.supplierName}'/>"> <!-- FILE NAME -->
			      </div>
			      <div class="large-4 columns">
  ...
  <c:if test="${sessionScope.isPartner == false}">
    ...
    <option value="3">Banking</option>
			     ...
			     <div class="row">
			     	...
			     	<div class="small-8 columns">
			     		<a href="/ClientJobs.html"><input type="button" class="button-submit" value="Cancel"  /></a>
			     	</div>
			     </div>
