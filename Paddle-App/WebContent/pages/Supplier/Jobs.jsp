...
<body onload="loadSupplierMenu();">
	...
	<div class="wrap-app">
       ...
       <form action="/SupplierAddJob.html" method="post" class="custom">    <!--Action   -->
  ...
  <div id="uploadFile" style="display:none;">
   <div class="row" >
		<input type="hidden" name="uploadJobId" id="uploadJobId">		
				...
				<div class="large-4 columns">
  <select id="jobstatusId" name="jobstatusId"  required = "required">
    <option value="2">Incomplete Dox</option>
    <option value="3">Complete Dox</option>    
  </select>
				</div>
...
<table class="table-transactions">
  ...
  <%--  <td><a href="javascript:UploadFileDiv(<c:out value='${listItems.id}'/>)" class="small button">Upload</a></td> --%>
  <td><a href="/CoverSheet.html?jobId=<c:out value='${listItems.id}'/>" class="small button">Upload</a></td>
						<td>  <i  class="foundicon-edit"  onclick="javascript:loadEditJobPage(<c:out value='${listItems.id}'/>)"></i> </td> <!--  onclick="javascript:loadEditJobPage(<c:out value='${listItems.id}'/>)"-->
					</tr>
				</c:forEach>	 
				</tbody>
			</table>
