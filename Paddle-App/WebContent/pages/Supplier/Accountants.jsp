	...
	<div class="wrap-app">
		<div class="row app-body">
			...
			<div class="large-10 columns">
					...
					<fieldset>
						<legend>Accountants</legend>


						<!-- Details -->
						<c:choose>
							<c:when test="${requestScope.acountantDetails!=null}">
								...
								<table class="table-transactions">
									...
									<tbody>
										<c:forEach var="listItems"
											items="${requestScope.acountantDetails}">
											<tr>
												<td><c:out value='${listItems.userName}' /></td>
												<td>Active</td>
												<td> <i class="foundicon-trash" onClick="javascript:deleteAccountants(<c:out value='${listItems.id}'/>);"></i> </td>
							...
							<c:otherwise>
								<div class="large-8 columns" id="Addbutton">
									No Accountant Found! <input type="button" class="button-add"
										value="ADD" onclick="javascript:showHideDiv('1');" />
								</div>
							</c:otherwise>
						</c:choose>
